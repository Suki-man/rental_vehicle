...
namespace Rental_System
{
    public partial class Pickup_List : Form
    {
        ...
        public Pickup_List(string username)
        {
            InitializeComponent();
        ...
        private void LoadVehicleData()
        {
            try
            {
                ...
                {
                    string query = "SELECT reg, model, color, fuel, transmission, RENTED_BY, picture FROM VEHICLE WHERE type = 'Pickup'";
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0 && dataGridView1.Columns[e.ColumnIndex].Name == "ViewPhoto")
            {
                try
                {
                    ...
                    {
                        MessageBox.Show("No image stored for this pickup.");
                    }
                }
                catch (Exception ex)
                {
        ...
        private void ShowImagePopup(byte[] imgBytes)
        {
            try
            {
                using (MemoryStream ms = new MemoryStream(imgBytes))
                {
                    ...
                    previewForm.Text = "Pickup Preview";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please select a pickup first.");
                return;
            }
            ...
            BookingData.VehicleType = "Pickup"; 
        ...
        // Unused
        private void Pickup_List_Load(object sender, EventArgs e) { }
        private void Pickup_List_Load_1(object sender, EventArgs e) { }
