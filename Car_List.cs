...
namespace Rental_System
{
    public partial class Car_List : Form
    {
        ...
        public Car_List(string username)
        {
            InitializeComponent();
        ...
        private void LoadVehicleData()
        {
            try
            {
                ...
                {
                    // Fetch picture data
                    string query = "SELECT reg, model, color, fuel, transmission, RENTED_BY, picture FROM VEHICLE WHERE type = 'Car'";
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0 && dataGridView1.Columns[e.ColumnIndex].Name == "ViewPhoto")
            {
                ...
                try
                {
                    ...
                    {
                        MessageBox.Show("No image stored for this vehicle.");
                    }
                }
                catch (Exception ex)
                {
        ...
        // Unused
        private void Car_List_Load(object sender, EventArgs e) { }
        private void Car_List_Load_1(object sender, EventArgs e) { }
